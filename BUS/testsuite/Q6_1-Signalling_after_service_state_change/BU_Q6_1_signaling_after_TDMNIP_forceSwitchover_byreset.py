...
#
# Modified: 2012.12.27
# 2013.7.9 using reset RU to replace reset node to trigger switchover.
# reset RU on APS active node won't make call failed. 
#=====================================================================
#/usr/bin/python
import re
import sys
...
#reset active TDMSNIUP RU to make RU level switchover
cmd = 'hascli -rn ' + activeRU
log(cmd)
output = cli(cmd)
log(output)
send_trigger()
